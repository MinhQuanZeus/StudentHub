                                        ...
                                        <div className="form-group">
                                            ...
                                            <span className="input-group-addon">
                                                ...
                                                <input type="email" id="login_username" name="login_username"
                                                       className="form-control" onChange={this.props.changeEmail}/>
                                            </div>
                                        </div>
                                        <div className="form-group">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <input type={this.state.passwordType} id="login_password" name="login_password"
                                                       className="form-control" onChange={this.props.changePassword} />
