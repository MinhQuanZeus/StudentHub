    ...
    return (
      <Popup title="Create New Flag" isOpen={props.isOpen} className={css.FlagCreator} onDismiss={props.onDismiss}>
        ...
        <div className={css.Body}>
          <Step1 current={state.current} categories={state.categories} onNext={this.next} />
          <Step2 current={state.current} onNext={this.next} onPrevious={this.previous} />
          <Step3 current={state.current} staffs={state.staffs} onPrevious={this.previous} onNext={this.next} />
          <Step4 current={state.current} students={state.students} onNext={this.next} onPrevious={this.previous} />
        </div>
      </Popup>
    );
  }
